...
import type { GradientHighlightProps, TexturePreset } from "./types";
...
const PaintedWord: React.FC<{
  ...
  return (
    ...
    >
      {/* Bottom layer: stroke/outline using glowColor */}
      <span
        style={{
      ...
      {/* Top layer: gradient fill clipped to text */}
      <span
        style={{
          position: "absolute",
          top: 0,
...
const TexturedPage: React.FC<{
  ...
  const groups: { tokens: TikTokToken[]; isPainted: boolean; texture: TexturePreset }[] = [];
